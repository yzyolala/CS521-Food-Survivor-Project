...
async function main() {
    ...
    const DreamZ = await restaurantsData.create("DreamZ Beauty Restaurant", "Washington Street Hoboken", "07030", [["magicbox", 3]])
    // console.log(DreamZ, "DreamZ has been added successfully")

    const Telogen = await restaurantsData.create("Telogen Restaurant & Bar", "Washington Street Hoboken", "07030", [[["magicbox", 3]]])
    // console.log(Telogen, "Telogen has been added successfully")

    const Roger = await restaurantsData.create("Roger Markel Restaurant", "Washington Street Hoboken", "07030", [[["magicbox", 3]]])
    // console.log(Roger, "Roger has been added successfully")

    const Bloom = await restaurantsData.create("Bloom berk lounge", "Washington Street Hoboken", "07030", [[["magicbox", 3]]])
